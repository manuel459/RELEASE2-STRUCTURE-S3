def get_data(glue_context, connection, p_fecha_inicio, p_fecha_fin):
    ...
    INSUNIX_LPG_2020  =  f'''
                             ...
                             * case when not exists (	select  1
                             ...
                             from	(	select 	cla.ctid cla_id,
                                                                                ...
                                                                                (	select 	max(greatest(
                                                                                                                case when clm.compdate <= dat.dat_fin then clm.compdate else '0001-01-01'::date end,
                                                                                                                case when clh.compdate <= dat.dat_fin then clh.compdate else '0001-01-01'::date end,
                                                                                                                case when clh.operdate <= dat.dat_fin then clh.operdate else '0001-01-01'::date end,
                                                                                                                case when cla.compdate <= dat.dat_fin then cla.compdate else '0001-01-01'::date end))
                                                                                        from	usinsug01.claim_his clh
                                                                                        ...
                                                                                        and		trim(clh.oper_type) in 
                                                                                                        (	select	cast(operation as varchar(2))
                                                                                                                ...
                                                                                                                where	reserve = 1 or ajustes = 1 or pay_amount = 1)) xxxxdate, --se busca la mayor fecha a la fecha final
                                                                                dat.dat_fin dat_lim
                                                                from 	usinsug01.policy pol --consideraci�n solo de este ramo por el volumen de datos asociados
                                                                join	(	select	cast('{p_fecha_inicio}' as date) dat_ini, --rango inicial carga inicial (2019 para pruebas)
                                                                                        cast('{p_fecha_fin}' as date) dat_fin --rango final carga inicial (2022 para pruebas)
                                                                                ) dat on 1 = 1
                                                                join	usinsug01.claim cla
                                                                        ...
                                                                        and		cla.occurdat <= '12/31/2020'
                                        --			        and		cla.occurdat between '01/01/2021' and '12/31/2021'
                                        --			        and		cla.occurdat between '01/01/2022' and '12/31/2022'
                                        --			        and		cla.occurdat >= '01/01/2023' --este no va a funcionar si no se cambia dat_fin al 2023 tambi�n
                                                                        and		(cla.compdate between dat.dat_ini and dat.dat_fin --se consideran siniestros con modificaciones entre los rangos (limitaci�n carga inicial)
                                                                                        or	exists --a nivel de transacciones
                                                                                                (   select  1
                                                                                                        ...
                                                                                                        and     (clh.operdate between dat.dat_ini and dat.dat_fin --se consideran siniestros con operaciones entre los rangos (limitaci�n carga inicial)
                                                                                                                        or clh.compdate between dat.dat_ini and dat.dat_fin)) --se consideran siniestros con modificaciones entre los rangos (limitaci�n carga inicial)								
                                                                                                ...
                                                                                                (   select  1
                                                                                                        from	usinsug01.claim_his clh
                                                                                                                        ...
                                                                                                                        and		clm.claim = clh.claim
                                                                                                                        and		clm.movement = clh.transac
                                                                                                                        and		clm.compdate between dat.dat_ini and dat.dat_fin --se consideran coberturas con modificaciones entre los rangos (limitaci�n carga inicial)
                                                                                                        where	clh.claim = cla.claim
                                                                                                        and		trim(clh.oper_type) in 
                                                                                                                        (select cast(operation as varchar(2)) from usinsug01.tab_cl_ope where reserve = 1 or ajustes = 1 or pay_amount = 1)))										
                                                                ...
                                                                and		pol.company = 1
                                                                and		pol.certype = '2'
                                                                and		pol.branch = 23) cl0 --solo este ramo por el volumen de datos
    ...
    DF_INSUNIX_LPG_2020 = glue_context.read.format('jdbc').options(**connection).option("fetchsize",10000).option("dbtable",INSUNIX_LPG_2020).load()
    ...
    DF_INSUNIX_LPG_2021 = glue_context.read.format('jdbc').options(**connection).option("fetchsize",10000).option("dbtable",INSUNIX_LPG_2021).load()
    ...
    DF_INSUNIX_LPG_2022 = glue_context.read.format('jdbc').options(**connection).option("fetchsize",10000).option("dbtable",INSUNIX_LPG_2022).load()
    ...
    DF_INSUNIX_LPG_2023 = glue_context.read.format('jdbc').options(**connection).option("fetchsize",10000).option("dbtable",INSUNIX_LPG_2023).load()
    ...
    DF_INSUNIX_LPG = DF_INSUNIX_LPG_2020.union(DF_INSUNIX_LPG_2021).union(DF_INSUNIX_LPG_2022).union(DF_INSUNIX_LPG_2023).union(DF_INSUNIX_LPG_OTROS)
                   ...
                   (select 
                    ...
                    from (	select 	case	pol.bussityp
                                                                ...
                                                                coalesce((	select	sum(coalesce(
                                                                                        ...
                                                                                        where	clh.claim = cla.claim
                                                                                        and		trim(clh.oper_type) in (select cast(operation as varchar(2)) from usinsug01.tab_cl_ope where reserve = 1 or ajustes = 1)
                                                                                        and		clh.operdate <= dat.dat_fin),0) monto_trans,
                                                                coalesce((	select	evi.scod_vt
                                                                                        from	usinsug01.equi_vt_inx evi 
                                                                                        where	evi.scod_inx = cla.client),
                                                                                cla.client) client,
                                                ...
                                                join	(	select	cast('{p_fecha_inicio}' as date) dat_ini, --rango inicial carga inicial (2018 para pruebas)
                                                                        cast('{p_fecha_fin}' as date) dat_fin --rango final carga inicial (2022 para pruebas)
                                                                ) dat on 1 = 1
                                                        ...
                                                        and		(cla.compdate between dat.dat_ini and dat.dat_fin --se consideran siniestros con modificaciones entre los rangos (limitaci�n carga inicial)
                                                                        or	exists --a nivel de transacciones
                                                                                ...
                                                                                (   select  1
                                                                                        ...
                                                                                        where	clh.claim = cla.claim
                                                                                        and		trim(clh.oper_type) in 
                                                                                                        (select cast(operation as varchar(2)) from usinsug01.tab_cl_ope where reserve = 1 or ajustes = 1 or pay_amount = 1)))) cl0
                    ...
                    from (	select  cla.ctid cla_id,
                                        ...
                                        (   select  max(cpl."NCURRENCY")
                                                        ...
                                                        coalesce((	select	sum(case	coalesce(
                                                                                ...
                                                                                where	clh."NCLAIM" = cla."NCLAIM"
                                                                                and		clh."NOPER_TYPE" in (select cast("SVALUE" as INT4) from usvtimg01."CONDITION_SERV" where "NCONDITION" in (71,72)) 
                                                                                and     cast(clh."DOPERDATE" as date) <= dat.dat_fin),0) monto_trans,
                                                        case	pol."SBUSSITYP"
                                                                        when	'2'
                                                ...
                                                case	when	NOT (pol."SPOLITYPE" = '2' AND cla."NBRANCH" = 57 AND cla."NPRODUCT" = 1)
                                                                ...
                                                                ELSE    0 END flag_rea,
                                                        (	select 	max(greatest(
                                                                                        case when cast(clm."DCOMPDATE" as date) <= dat.dat_fin then cast(clm."DCOMPDATE" as date) else '0001-01-01'::date end,
                                                                                        case when cast(clh."DCOMPDATE" as date) <= dat.dat_fin then cast(clh."DCOMPDATE" as date) else '0001-01-01'::date end,
                                                                                        case when cast(clh."DOPERDATE" as date) <= dat.dat_fin then cast(clh."DOPERDATE" as date) else '0001-01-01'::date end,
                                                                                        case when cast(cla."DCOMPDATE" as date) <= dat.dat_fin then cast(cla."DCOMPDATE" as date) else '0001-01-01'::date end))
                                                                from	usvtimg01."CLAIM_HIS" clh
                                                        ...
                                                        and		clm."NTRANSAC" = clh."NTRANSAC"
                                                                ...
                                                                and		(clh."DOPERDATE" <= dat.dat_fin or clh."DCOMPDATE" <= dat.dat_fin) --evita tomar operaciones posteriores (carga incremental)
                                                                ) xxxxdate,
                                                        dat.dat_fin dat_lim
                                        from    (	select	ctid pol_id
                                        ...
                                        join	usvtimg01."CLAIM" cla
                                                ...
                                                and     cla."SSTACLAIM" <> '6'
                                                and		(cast(cla."DCOMPDATE" as date) between dat.dat_ini and dat.dat_fin
                                                                        or	exists
                                                                (   select  1
                                                                from    usvtimg01."CLAIM_HIS" clh
                                                                where	clh."NCLAIM" = cla."NCLAIM"
                                                                and		coalesce(clh."NCASE_NUM",0) >= 0
                                                                                        and     (cast(clh."DOPERDATE" as date) between dat.dat_ini and dat.dat_fin --se consideran siniestros con operaciones entre los rangos (limitaci�n carga inicial)
                                                                                                        or cast(clh."DCOMPDATE" as date) between dat.dat_ini and dat.dat_fin) --se consideran siniestros con modificaciones entre los rangos (limitaci�n carga inicial)
                                                                ...
                                                                from    usvtimg01."CLAIM_HIS" clh
                                                                                ...
                                                                                and		clm."NDEMAN_TYPE" = clh."NDEMAN_TYPE"
                                                                                and		clm."NTRANSAC" = clh."NTRANSAC"
                                                                                and		cast(clm."DCOMPDATE" as date) between dat.dat_ini and dat.dat_fin --se consideran coberturas con modificaciones entre los rangos (limitaci�n carga inicial)
                                                                where	clh."NCLAIM" = cla."NCLAIM"
                                                                and		coalesce(clh."NCASE_NUM",0) >= 0
                                                                                        and		clh."NOPER_TYPE" in 
                   ...
                   (select 
                    ...
                    from (	select  cla.ctid cla_id,
                                        ...
                                        from    (	select	ctid pol_id
                                                                ...
                                                                where	"SCERTYPE" = '2') po0
                                        join	(	select	cast('{p_fecha_inicio}' as date) dat_ini, --rango inicial carga inicial (2015 para pruebas)
                                                                cast('{p_fecha_fin}' as date) dat_fin --rango final carga inicial (2017 para pruebas)
                                                        ) dat on 1 = 1
    ...
    L_DF_SBSIN = DF_INSUNIX_LPG.union(DF_INSUNIX_LPV).union(DF_VTIME_LPG).union(DF_VTIME_LPV)
