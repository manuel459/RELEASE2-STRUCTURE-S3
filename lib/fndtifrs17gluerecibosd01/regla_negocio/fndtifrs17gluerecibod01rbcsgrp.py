def get_data(glue_context, connection):
    ...
    L_RBCSGRP_INSUNIX_LPG_NEGOCIO1 = '''
                                        (
    ...
    L_RBCSGRP_INSUNIX_LPG_NEGOCIO2 = '''
                                        (
                                           select	'D' as INDDETREC,
                                                        'RBCSGRP' as TABLAIFRS17, 
                                                        pre.receipt KRBRECPR,
                                                        ...
                                                        and    pol.policy = pre.policy) TIOCFRM, --excluido
                                                        '' TIOCTO, --excluido
                                                        'PIG' KGIORIGM, --excluido
    ...
    L_RBCSGRP_INSUNIX_LPV_NEGOCIO1 = '''
                                        (
                                            select	'D' as INDDETREC,
                                                        'RBCSGRP' as TABLAIFRS17,
                                                        pre.receipt KRBRECPR,
    ...
    L_RBCSGRP_INSUNIX_LPV_NEGOCIO2 = '''
                                        (
                                            select	'D' as INDDETREC,
                                                        'RBCSGRP' as TABLAIFRS17,
                                                        pre.receipt KRBRECPR,
    ...
    L_RBCSGRP_VTIME_LPG = '''
                              (
                                   select	'D' as INDDETREC,
                                                ...
                                                '' DTPREG, --excluido
                                                '' TIOCPROC, --excluido
                                                CAST (coi."DCOMPDATE" AS DATE)  TIOCFRM, --excluido
                                                '' TIOCTO, --excluido
