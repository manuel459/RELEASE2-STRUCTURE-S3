		       ...
		       '' TCRIACAO --excluido
                       from	(	select	cla.cla_id,
                                               ...
                                               join 	usinsug01.claim_his clh
                                                               ...
                                                               and		clh.operdate between cla.dat_ini and cla.dat_fin
                                               join 	usinsug01.cl_m_cover clm
                                                               on		clm.usercomp = clh.usercomp
                                                               and		clm.company = clh.company
                                                               and		clm.claim = clh.claim
		     ...
		     '' TCRIACAO --excluido
                     from	(	select	cla.cla_id,
                                             ...
                                             join	usvtimg01."CLAIM_HIS" clh
                                                             ...
                                                             and		cast(clh."DOPERDATE" as date) between cla.dat_ini and cla.dat_fin
                                             ...
                                             from	(	select  cla."NCLAIM" nclaim,
                                                             ...
                                                             cast(cla."DOCCURDAT" as date) doccurdat,
                                                                     ...
                                                                     from    (	select	ctid pol_id
                                                                                             ...
                                                                                             where	"SCERTYPE" = '2') po0
                                                                     join	(	select	cast('01/01/2018' as date) par_ini, --rango inicial carga incremental (variable a elecci�n)
                                                                                                             cast('01/31/2018' as date) par_fin --rango final carga incremental (variable a elecci�n)
                                                                                     ) dat on 1 = 1
    ...
    INSIS_LPV = f'''
		     ...
		     '' TCRIACAO --excluido
                     ...
                     join	usinsiv01."CLAIM_RESERVE_HISTORY" clh
                                     ...
                                     and		clh."OP_TYPE" IN ('REG','EST','CLC')
                                     and		cast(clh."REGISTRATION_DATE" as date) between cla.dat_ini and cla.dat_fin
