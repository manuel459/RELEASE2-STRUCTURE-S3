...
def get_data(glue_context, connection, p_fecha_inicio, p_fecha_fin):
  ...
  l_polizas_vtime_lpg = f'''
                      (
                        (SELECT
                         ...
                         CASE COALESCE(P."SPOLITYPE", '') WHEN '2' 
                         THEN CASE WHEN CERT."NCERTIF" <> 0 
                              THEN CAST(P."NBRANCH" AS VARCHAR) || '-' || CAST(P."NPRODUCT" AS VARCHAR) || '-' || P."NPOLICY" || '-' || '0'
                         ELSE ''
                         END
                         ELSE '' 
                         END AS KABAPOL,
                         ...
                         '' AS DTERMO, --EN BLANCO
                         COALESCE(CASE WHEN P."SPOLITYPE" = '1' 
                                  THEN P."SCLIENT"
                                  ELSE CERT."SCLIENT"
                                  END, '') AS KEBENTID_TO,
                         ...
                         '' AS KACCDGER,
                         COALESCE((SELECT CAST(CP."NCURRENCY" AS VARCHAR) FROM USVTIMG01."CURREN_POL" CP 
                         ...
                         '' AS KCBMED_PD,  --NO
                         COALESCE(COALESCE((SELECT COALESCE(CO."NPERCENT",0) 
		                                    FROM  USVTIMG01."COMMISSION" CO 
		                                    WHERE  CO."SCERTYPE" = '2'
                         ...
                         COALESCE(COALESCE((SELECT COALESCE("NAMOUNT", 0)
		                                    FROM  USVTIMG01."COMMISSION" CO 
		                                    WHERE  CO."SCERTYPE" = '2'
		                                    AND    CO."NBRANCH"  = P."NBRANCH"
		                                    AND       CO."NPRODUCT" = P."NPRODUCT"     
                         ...
                         '' AS VTXCOMME,  --NO
                         '' AS VMTCOMME,  --NO
                         COALESCE((SELECT SUM(COALESCE(COV."NCAPITAL",0)) 
                         ...
                         COALESCE((SELECT (COALESCE(C."NSHARE", 0) * COALESCE(P."NPREMIUM", 0))
                         ...
                         COALESCE((SELECT COALESCE(C."NSHARE", 0)
		                           FROM USVTIMG01."COINSURAN" C
		                           WHERE C."SCERTYPE" = '2'
		                           AND   C."NBRANCH"  = P."NBRANCH" 
		                           AND   C."NPRODUCT" = P."NPRODUCT"
                         ...
                         COALESCE((SELECT TRUNC(COALESCE(R."NSHARE",0),4)/100
		                           FROM USVTIMG01."REINSURAN" R
		                           JOIN USVTIMG01."COVER" C
		                           ON R."SCERTYPE" = C."SCERTYPE"
		                           ...
		                           AND (GC."DNULLDATE" IS NULL OR GC."DNULLDATE" > C."DEFFECDATE")
                         ...
                         COALESCE(((SELECT TRUNC(COALESCE(R."NSHARE",0),4)/100
		                            ...
		                            AND R."DEFFECDATE" <= P."DSTARTDATE"
		                            AND ( R."DNULLDATE" IS NULL OR R."DNULLDATE" > P."DSTARTDATE")
		                            ORDER BY R."NCAPITAL" DESC LIMIT 1) * (SELECT SUM(COALESCE(C."NCAPITAL", 0)) 
                         ...
                         COALESCE((SELECT CAST(COALESCE(PH."NTYPE_HIST",0) AS VARCHAR) 
		                           FROM USVTIMG01."POLICY_HIS" PH
                        ...
                        (SELECT
                         ...
                         COALESCE(COALESCE((SELECT COALESCE(CO."NPERCENT",0) 
		                                    ...
		                                    AND    (CO."DNULLDATE" IS NULL OR CO."DNULLDATE" > P."DSTARTDATE")
		                                    AND    CO."NINTERTYP" <> 1
		                                    LIMIT 1),(SELECT COALESCE(CO."NPERCENT",0) 
		                                              FROM  USVTIMG01."COMMISSION" CO 
				                                      WHERE  CO."SCERTYPE" = '2'
				                                      AND    CO."NBRANCH"  = P."NBRANCH"
				                                      AND    CO."NPRODUCT" = P."NPRODUCT"    
                         ...
                         COALESCE(COALESCE((SELECT COALESCE("NAMOUNT", 0) 
		                                    ...
		                                    AND    (CO."DNULLDATE" IS NULL OR CO."DNULLDATE" > P."DSTARTDATE")
		                                    AND    CO."NINTERTYP" <> 1
		                                    LIMIT 1),(SELECT COALESCE(CO."NAMOUNT", 0) 
		                                              FROM  USVTIMG01."COMMISSION" CO 
				                                      WHERE CO."SCERTYPE" = '2'
				                                      AND   CO."NBRANCH"  = P."NBRANCH"
				                                      AND     CO."NPRODUCT" = P."NPRODUCT"
                         ...
                         '' AS VTXCOMME,  --NO
                         '' AS VMTCOMME,  --NO
                         COALESCE((SELECT SUM(COALESCE(COV."NCAPITAL",0)) FROM USVTIMG01."COVER" COV
		                           WHERE COV."SCERTYPE" = P."SCERTYPE"
		                           AND   COV."NBRANCH"  = P."NBRANCH"
		                           AND   COV."NPRODUCT" = P."NPRODUCT"
		                           AND   COV."NPOLICY"  = P."NPOLICY" 
                         ...
                         WHERE P."SCERTYPE" = '2'
                         AND P."SSTATUS_POL" NOT IN ('2','3')
                         AND ((P."SPOLITYPE" = '1' AND (CAST(P."DEXPIRDAT" AS DATE) < '{l_fecha_carga_inicial}' OR CAST(P."DNULLDATE" AS DATE) < '{l_fecha_carga_inicial}')
                               AND (EXISTS (SELECT 1 FROM USVTIMG01."CLAIM" CLA 
                                            JOIN (SELECT DISTINCT CLH."NCLAIM" 
                                                  FROM (SELECT CAST("SVALUE" AS INT4) "SVALUE" 
	                                                    ...
	                                                    WHERE CS."NCONDITION" IN (71, 72, 73)
	                                                   ) CSV 
	                                        ...
	                                        AND CLA."NCERTIF"  =  0
                                              ...
                                              OR (P."SPOLITYPE" <> '1' AND (CAST(CERT."DEXPIRDAT" AS DATE) < '{l_fecha_carga_inicial}' OR CAST(CERT."DNULLDATE" AS DATE) < '{l_fecha_carga_inicial}')
                                              AND ((EXISTS (SELECT 1 FROM USVTIMG01."CLAIM" CLA                                           
                                                                     JOIN (SELECT DISTINCT CLH."NCLAIM" 
							                                               FROM (SELECT CAST("SVALUE" AS INT4) "SVALUE" 
							                                                     FROM USVTIMG01."CONDITION_SERV" CS 
  ...
  l_polizas_vtime_lpv = f'''
                        (
                          (SELECT
                           ...
                           CASE COALESCE(P."SPOLITYPE", '') WHEN '2' 
                           THEN CASE WHEN CERT."NCERTIF" <> 0 
                                THEN P."NBRANCH" || '-' || P."NPRODUCT" || '-' || P."NPOLICY" || '-' || '0'
                           ELSE ''
                           END
                           ELSE '' 
                           END AS KABAPOL,
                           ...
                           COALESCE(CASE WHEN P."SPOLITYPE" = '1' 
                                    THEN P."SCLIENT"
		                                ELSE CERT."SCLIENT"
		                                END, '') AS KEBENTID_TO,
                           COALESCE(CAST(CAST((CASE WHEN P."SPOLITYPE" = '1' 
                                               THEN P."DDATE_ORIGI"
					                                     ELSE CERT."DDATE_ORIGI"
                						                   END) AS DATE) AS VARCHAR),'') AS TCRIAPO,
                           COALESCE(CAST(CAST((CASE WHEN P."SPOLITYPE" = '1' 
                           ...
                           COALESCE(CAST(CAST((CASE WHEN P."SPOLITYPE" = '1' 
                                       		   THEN P."DDATE_ORIGI"
					                           ELSE CERT."DDATE_ORIGI"
                						       END) AS DATE) AS VARCHAR), '') AS TINICIO,
                           '' AS DHORAINI,
                           COALESCE(CAST(CAST((CASE WHEN P."SPOLITYPE" = '1' 
                               				   THEN P."DEXPIRDAT"
					                           ELSE CERT."DEXPIRDAT"
                           ...
                           COALESCE(CAST(CAST((CASE WHEN P."SPOLITYPE" = '1' 
					                           ...
					                           END) AS DATE) AS VARCHAR),'') AS TANSUSP,
                           '' AS TESTADO,
                           COALESCE ((CASE WHEN P."SPOLITYPE" IN ('2', '3') AND CERT."NCERTIF" <> 0 
                                      THEN CERT."SSTATUSVA"
		                              ELSE P."SSTATUS_POL"
		                              END), '') AS KACESTAP,
                           '' AS KACMOEST, --NO
                           ...
                           COALESCE(P."SCOLREINT", '') AS KACINDRE,
                           '' AS KACCDGER, --NO
                           COALESCE((SELECT CAST(CP."NCURRENCY" AS VARCHAR) 
                           ...
                           '' AS VMTCOMCB, --ACLARAR
                           '' AS KCBMED_PD,--NO
                           COALESCE(COALESCE((SELECT COALESCE("NPERCENT", 0)
                                              FROM  USVTIMV01."COMMISSION" CO 
	                                          WHERE  CO."SCERTYPE" = '2'
	                                          AND    CO."NBRANCH"  = P."NBRANCH"
	                                          AND    CO."NPRODUCT" = P."NPRODUCT"     
	                                          AND    CO."NPOLICY"  = P."NPOLICY"
	                                          ...
	                                          AND   (CO."DNULLDATE" IS NULL OR CO."DNULLDATE" > P."DSTARTDATE")
	                                          AND    CO."NINTERTYP" <> 1
	                                          LIMIT 1),(SELECT COALESCE("NPERCENT", 0) 
	                                                    FROM  USVTIMV01."COMMISSION" CO 
				                                        WHERE  CO."SCERTYPE" = '2'
				                                        AND    CO."NBRANCH"  = P."NBRANCH"
				                                        AND    CO."NPRODUCT" = P."NPRODUCT"    
                           ...
                           COALESCE(COALESCE((SELECT COALESCE("NAMOUNT", 0)
                                                FROM  USVTIMV01."COMMISSION" CO 
		                                         ...
		                                         AND   (CO."DNULLDATE" IS NULL OR CO."DNULLDATE" > P."DSTARTDATE")
		                                         AND    CO."NINTERTYP" <> 1
		                                         LIMIT 1),(SELECT COALESCE("NAMOUNT", 0) 
		                                                   FROM  USVTIMV01."COMMISSION" CO 
					                                       WHERE  CO."SCERTYPE" = '2'
					                                       AND    CO."NBRANCH"  = P."NBRANCH"
					                                       AND    CO."NPRODUCT" = P."NPRODUCT"    
                           ...
                           COALESCE(((SELECT TRUNC(COALESCE(R."NSHARE", 0),2) /100
	                                  ...
	                                  AND   R."NCOMPANY" = 1
	                                  AND  R."NTYPE_REIN" = 1
	                                  AND  R."NCOVER" = 1) * (SELECT SUM(COALESCE(C."NCAPITAL", 0)) 
                          ...
                          (SELECT
                           ...
                           COALESCE(CAST(CAST((CASE WHEN P."SPOLITYPE" = '1' 
                                               THEN P."DEXPIRDAT"
					                           ELSE CERT."DEXPIRDAT"
					                           END) AS DATE) AS VARCHAR),'') AS TVENANU,
                           COALESCE(CAST(CAST((CASE WHEN P."SPOLITYPE" = '1' 
                                               THEN P."DNULLDATE"
					                           ELSE CERT."DNULLDATE"
					                           END) AS DATE) AS VARCHAR),'') AS TANSUSP,
                           ...
                           COALESCE((SELECT COALESCE(E."NEXCHANGE", 0)
                             ...
                             COALESCE (( SELECT CAST(COALESCE (PH."NTYPE_HIST",0) AS VARCHAR) 
		                                 ...
		                                 AND  (PH."DNULLDATE" IS NULL OR PH."DNULLDATE" > P."DSTARTDATE")
		                                 AND   PH."NTYPE_HIST" = 1 --EN EMISION
		                                 LIMIT 1),'0') AS KACTPTRA, --TODAY ACLARAR
                             '' AS TEMICANC,--NO
                             '' AS DENTIDSO,--NO
                             '' AS DARQUIVO,--NO
                             '' AS TARQUIVO,--NO
                             ...
                             AND (EXISTS (SELECT 1 FROM USVTIMV01."CLAIM" CLA
                                          ...
                                          AND CLA."NPRODUCT" = P."NPRODUCT"
                                          AND CLA."NPOLICY"  = P."NPOLICY"  
                                          AND CLA."NCERTIF"  =  0))) OR (P."SPOLITYPE" <> '1' AND (CAST(CERT."DEXPIRDAT" AS DATE) < '{l_fecha_carga_inicial}' OR CAST(CERT."DNULLDATE" AS DATE) < '{l_fecha_carga_inicial}')
										                             AND ((EXISTS (SELECT 1 FROM USVTIMV01."CLAIM" CLA                                           
										                                           JOIN (SELECT DISTINCT CLH."NCLAIM" 
										                                                 FROM (SELECT CAST("SVALUE" AS INT4) "SVALUE" 
												                                               FROM USVTIMV01."CONDITION_SERV" CS 
  ...
  l_polizas_insunix_lpg = f'''
                          (SELECT 
                           ...
                           CASE P.POLITYPE WHEN '2' 
                           THEN CASE WHEN P.CERTIF <> 0 
                                THEN P.BRANCH || '-' || CAST(COALESCE (P.PRODUCT, 0) AS VARCHAR) || '-' || COALESCE(P.SUB_PRODUCT, 0) || '-' || P.POLICY || '-' || '0'
                           ELSE ''
                           END
                           ELSE '' 
                           END AS KABAPOL,
                           ...
                           '' AS DTERMO,     --BLANCO
                           COALESCE(( SELECT 'PAE' || '-' || SCOD_VT 
                                      FROM USINSUG01.EQUI_VT_INX EVI
                                      WHERE EVI.SCOD_INX =  (CASE WHEN P.POLITYPE = '1' 
                                                             THEN P.TITULARC 
                                                             ELSE P.CERT_TITULARC 
                                                             END
                                                             )
                                    ), '') AS KEBENTID_TO,
                           COALESCE(CAST((CASE WHEN P.POLITYPE = '1' 
                                          THEN P.DATE_ORIGI 
                                          ELSE P.CERT_DATE_ORIGI 
                                          END) AS VARCHAR),  '') AS TCRIAPO, 
                           COALESCE(CAST((CASE WHEN P.POLITYPE = '1' 
                                          THEN P.ISSUEDAT   
                                          ELSE P.CERT_ISSUEDAT   
                                          END) AS VARCHAR) , '') AS TEMISSAO,
                           COALESCE(CAST((CASE WHEN P.POLITYPE = '1' 
                                          THEN P.EFFECDATE  
                                          ELSE P.CERT_EFFECDATE
                                          END) AS VARCHAR) , '') AS TINICIO,
                           '' AS DHORAINI, --NO
                           COALESCE(CAST((CASE WHEN P.POLITYPE = '1' 
                                          THEN P.EXPIRDAT  
                                          ELSE P.CERT_EXPIRDAT  
                                          END) AS VARCHAR) , '')  AS TTERMO,
                           COALESCE(CAST((CASE WHEN P.POLITYPE = '1' 
                                          THEN P.EFFECDATE 
                                          ELSE P.CERT_EFFECDATE 
                                          END) AS VARCHAR) , '')  AS TINIANU,
                           COALESCE(CAST((CASE WHEN P.POLITYPE = '1' 
                                          THEN P.EXPIRDAT  
                                          ELSE P.CERT_EXPIRDAT  
                                          END) AS VARCHAR) , '')  AS TVENANU,
                           COALESCE(CAST((CASE WHEN P.POLITYPE = '1' 
                                          THEN P.NULLDATE  
                                          ELSE P.CERT_NULLDATE  
                                          END) AS VARCHAR) , '')  AS TANSUSP,
                           '' AS TESTADO,
                           COALESCE((CASE WHEN P.POLITYPE = '1' 
                        			 THEN P.STATUS_POL 
                        			 ELSE P.CERT_STATUSVA 
                        			 END) , '') AS KACESTAP,
                           '' AS KACMOEST, --NO
                           COALESCE(CAST((CASE WHEN P.POLITYPE = '1' 
                           				  THEN P.EFFECDATE 
                           				  ELSE P.CERT_EFFECDATE 
                           				  END) AS VARCHAR), '') AS TEFEACTA,
                           '' AS DULTACTA,--NO
                           '' AS KACCNEMI,--NO
                           '' AS KACARGES,--NO
                           '' AS KACAGENC,--NO
                           ...
                           '' AS KACCDGER,--NO
                           COALESCE ((SELECT CAST(CURRENCY AS VARCHAR) 
                                      ...
                                      LIMIT 1), '0') AS KACMOEDA,
                           COALESCE(( SELECT COALESCE(E.EXCHANGE, 0)
                                      ...
                                      AND (E.NULLDATE IS NULL OR E.NULLDATE > P.EFFECDATE)), 0) AS VCAMBIO,
                           '' AS KACREGCB,  --NO
                           '' AS KCBMED_DRA,--NO
                           '' AS KCBMED_CB, --NO
                           COALESCE((SELECT COALESCE(TRUNC(DX.PERCENT, 4), 0) 
                                     ...
                                     AND DE.BILL_ITEM = 4
                                     AND DE.CURRENCY = (SELECT CP.CURRENCY
                                      					FROM USINSUG01.CURREN_POL CP
                                                        WHERE CP.USERCOMP = P.USERCOMP 
                                                        AND CP.COMPANY = P.COMPANY
                                                        AND CP.CERTYPE = P.CERTYPE
                                                        ...
                                                        AND CP.EFFECDATE <= P.EFFECDATE
                                                        AND (CP.NULLDATE IS NULL OR CP.NULLDATE > P.EFFECDATE) 
                                                        LIMIT 1) LIMIT 1), 0) AS VTXCOMCB, 
                           '' AS VMTCOMCB,  --EN BLANCO
                           '' AS KCBMED_PD, --NO
                           COALESCE (COALESCE((SELECT COALESCE(PERCENT, 0)
                           ...
                           COALESCE (COALESCE((SELECT COALESCE(C.AMOUNT, 0) 
                                               FROM USINSUG01.COMMISSION C 
                                               WHERE C.USERCOMP = P.USERCOMP 
                                               AND   C.COMPANY  = P.COMPANY 
                                               AND   C.CERTYPE  = P.CERTYPE
                                               ...
                                               AND   C.EFFECDATE <= P.EFFECDATE
                                               AND  (C.NULLDATE IS NULL OR C.NULLDATE > P.EFFECDATE)
                                               AND   C.ROLE <> 1 LIMIT 1)), 0) AS VMTCOMMD, 
                           '' AS KCBMED_P2, --NO
                           '' AS VTXCOMME,  --NO
                           '' AS VMTCOMME,  --NO
                           COALESCE(( SELECT SUM(COALESCE(C.CAPITAL, 0)) 
                                      ...
                                      AND   C.CERTIF   = P.CERTIF 
                                      AND   C.EFFECDATE <= P.EFFECDATE
                                      AND   (C.NULLDATE IS NULL OR C.NULLDATE > P.EFFECDATE)), 0) AS VCAPITAL,
                           '' AS VMTPRMSP, --NO
                           COALESCE(P.PREMIUM, 0) AS VMTCOMR,
                           COALESCE (( SELECT COALESCE (C.SHARE, 0) * COALESCE (P.PREMIUM, 0)
                                       FROM USINSUG01.COINSURAN C
                                       WHERE C.USERCOMP = 1
                           ...
                           COALESCE((SELECT COALESCE(C.SHARE, 0)
                                     FROM USINSUG01.COINSURAN C
                                     WHERE C.USERCOMP = 1
                                     AND C.COMPANY = 1 -- VALOR DE LA COMPANIA
                                     AND C.CERTYPE = '2'
                                     ...
                                     AND C.EFFECDATE <= P.EFFECDATE
                                     AND (C.NULLDATE IS NULL OR C.NULLDATE > P.EFFECDATE)
                                     AND C.COMPANYC = 1), 0) AS VTXCOSSG,
                           ...
                           COALESCE(((SELECT (TRUNC(COALESCE(SHARE, 0),4)/100)
                                      ...
                                      AND EFFECDATE <= P.EFFECDATE
                                      AND (R.NULLDATE IS NULL OR R.NULLDATE > P.EFFECDATE)
                                      AND R.TYPE = 1) * (SELECT SUM(COALESCE (CAPITAL, 0))
                                                          FROM USINSUG01.COVER C
                                                          WHERE C.USERCOMP = 1
                                                          AND C.COMPANY = 1
                                                          AND C.CERTYPE =  '2'
                                                          ...
                                                          AND C.CERTIF = P.CERTIF
                                                          AND EFFECDATE <= P.EFFECDATE
                                                          AND (C.NULLDATE IS NULL OR C.NULLDATE > P.EFFECDATE))), 0) AS VMTCAPRE,
                           '' AS DNUMVIAS,    --NO
                           '' AS DQTCRED,     --NO
                           '' AS DNIB,        --NO
                           '' AS DLOCREF,     --NO
                           ...
                           CASE 
                           WHEN P.POLITYPE = '1' THEN  COALESCE((SELECT CAST(PH.TYPE AS VARCHAR) FROM 
                                                                 USINSUV01.POLICY_HIS PH --EN EMISION
                                                                 ...
                                                                 AND   PH.TYPE = 1), '0') 
                           WHEN P.POLITYPE <> '1' THEN  COALESCE((SELECT CAST(PH.TYPE AS VARCHAR) 
                                                                 FROM USINSUV01.POLICY_HIS PH --EN EMISION
                                                                 WHERE PH.USERCOMP = P.USERCOMP
                                                                 AND   PH.COMPANY  = P.COMPANY
                                                                 AND   PH.CERTYPE  = P.CERTYPE
                                                                 AND   PH.BRANCH   = P.BRANCH
                           ...
                           (SELECT CAST(COUNT(*) AS VARCHAR) FROM USINSUG01.ROLES R 
                             ...
                             AND R.BRANCH    = P.BRANCH 
                             AND R.POLICY    = P.POLICY 
                             AND R.CERTIF    = P.CERTIF) AS DQTDPART,
                           ...
                           (
							...
							AND P.EFFECDATE BETWEEN '{p_fecha_inicio}' AND '{p_fecha_fin}') /*SE QUITO EL UNION, DESDE HASTA AQUI */ )P
                            ) AS TMP
                          '''
  ...
  l_polizas_insunix_lpv = f'''
                          (   SELECT 
                              ...
                              COALESCE((CASE WHEN P.POLITYPE = '1' 
                            			THEN P.STATUS_POL     
                            			ELSE P.CERT_STATUSVA END), '') AS KACESTAP,
                              '' AS KACMOEST, --NO
                              COALESCE(CAST((CASE WHEN P.POLITYPE = '1' 
                                			 THEN P.EFFECDATE 
                                			 ELSE P.CERT_EFFECDATE 
                              ...
                              COALESCE(COALESCE((SELECT COALESCE(PERCENT, 0) 
			                                     ...
			                                     AND   C.EFFECDATE <= P.EFFECDATE
			                                     AND  (C.NULLDATE IS NULL OR C.NULLDATE > P.EFFECDATE)
			                                     AND   C.ROLE <> 1 LIMIT 1),(SELECT COALESCE(PERCENT, 0) 
										                                     FROM USINSUV01.COMMISSION C 
										                                     WHERE C.USERCOMP = P.USERCOMP 
										                                     AND   C.COMPANY  = P.COMPANY 
										                                     AND   C.CERTYPE  = P.CERTYPE
                              ...
                              COALESCE(COALESCE((SELECT COALESCE(AMOUNT, 0) 
			                                     FROM USINSUV01.COMMISSION C 
			                                     WHERE C.USERCOMP = P.USERCOMP 
			                                     AND   C.COMPANY  = P.COMPANY 
			                                     AND   C.CERTYPE  = P.CERTYPE
			                                     ...
			                                     AND   C.EFFECDATE <= P.EFFECDATE
			                                     AND  (C.NULLDATE IS NULL OR C.NULLDATE > P.EFFECDATE)
			                                     AND   C.ROLE <> 1 LIMIT 1),(SELECT COALESCE(AMOUNT, 0) 
										                                     FROM USINSUV01.COMMISSION C 
										                                     WHERE C.USERCOMP = P.USERCOMP 
										                                     AND   C.COMPANY  = P.COMPANY 
										                                     AND   C.CERTYPE  = P.CERTYPE
                              ...
                              '' AS VTXCOMME,  --NO
                              '' AS VMTCOMME,  --NO
                              ( SELECT SUM(COALESCE(C.CAPITAL,0)) 
                              ...
                              '' AS VMTPRLIQ,--NO
                              COALESCE(P.PREMIUM, 0)  AS VMTPRMBR,
                              COALESCE((SELECT COALESCE(SHARE, 0)
		                                FROM USINSUV01.COINSURAN C
		                                WHERE C.USERCOMP = 1
		                                AND C.COMPANY = 1 -- VALOR DE LA COMPANIA
		                                AND C.CERTYPE = '2'
                              ...
                              '' AS DNMMULTI,--NO
                              '' AS DOBSERV, --NO
                              CAST((SELECT COUNT(*) FROM USINSUV01.ROLES R 
	                                WHERE R.USERCOMP = P.USERCOMP 
	                                AND R.COMPANY    = P.COMPANY 
	                                AND R.CERTYPE    = P.CERTYPE 
	                                AND R.BRANCH     = P.BRANCH 
                              ...
                              (CASE WHEN P.YEAR_MONTH > 3 
                               THEN COALESCE(CAST(TO_DATE(P.YEAR_MONTH::TEXT, 'YYYYMM') AS VARCHAR),'') 
                               ELSE '' 
                               END
                              ) AS TINIPRXANU,
                              '' AS KACTPREAP,    --EN BLANCO
                               ...
                               (SELECT 
                                ...
                                AND EXISTS (SELECT  1
                                            ...
                                            AND   TRIM(CLH.OPER_TYPE) IN  (SELECT CAST(TCL.OPERATION AS VARCHAR(2)) FROM  USINSUG01.TAB_CL_OPE TCL
                                                                             WHERE (TCL.RESERVE = 1 OR TCL.AJUSTES = 1 OR TCL.PAY_AMOUNT = 1))
                                            AND  CLH.OPERDATE >= '{l_fecha_carga_inicial}')))
                                AND P.EFFECDATE BETWEEN '{p_fecha_inicio}' AND '{p_fecha_fin}')/*SE QUITO EL UNION, DESDE HAST AQUI */) AS P
                          ) AS TMP
                          '''
   #Ejecutar consulta
  ...
  l_polizas_insis = f'''
                     (   SELECT
                      ...
                      'PNV' AS KGIORIGM,
                      'LPV' AS KACCOMPA,
                      COALESCE(P."ATTR1", '0') || '-' || ( SELECT COALESCE(P_COND."COND_DIMENSION", '0')
                                                           FROM USINSIV01."POLICY_CONDITIONS" P_COND
                                                           WHERE P_COND."POLICY_ID" = P."POLICY_ID"
                                                           AND P_COND."COND_TYPE" LIKE '%AS_IS%'
                                                           AND "ANNEX_ID" = ( SELECT MAX("ANNEX_ID") 
                                                                              FROM USINSIV01."POLICY_CONDITIONS" P_COND2
                                                                              WHERE P_COND2."POLICY_ID" = P."POLICY_ID"
                                                                              AND "COND_TYPE" LIKE '%AS_IS%')) AS KGCRAMO,
                      P."INSR_TYPE"  AS KABPRODT,
                      KABAPOL,
                      SUBSTRING(CAST(DNUMAPO AS VARCHAR),6,12) DNUMAPO,
                      SUBSTRING(CAST(DNMCERT AS VARCHAR),6,12) DNMCERT,
                      '' AS DTERMO, --EN BLANCO
                      COALESCE((SELECT 'PAE' || '-' || ILPI."LEGACY_ID" 
                      ...
                      (SELECT TP."COD_TIPO_POLIZA" 
                       FROM USBI01."IFRS170_T_TIPO_POLIZA" TP 
                       WHERE TP."NOM_TIPO_POLIZA" = P."ENG_POL_TYPE" 
                      ) AS KACTIPAP,
                      '' AS DFROTA,   --NO
                      '' AS KACTPDUR, --EN BLANCO
                      ...
                      COALESCE((SELECT '1' FROM USINSIV01."RI_FAC" RF
                      ...
                      (
                        ...
                        (CAST(COALESCE((  SELECT COUNT(DISTINCT PAR."MAN_ID")
		                                  ...
		                                  AND     PAR."ANNEX_ID" = 0
		                                  AND     DATE_TRUNC('SECOND', PAR."VALID_FROM") <= CAST(P."INSR_BEGIN" AS DATE)
		                                  AND     (PAR."VALID_TO" IS NULL OR DATE_TRUNC('SECOND', PAR."VALID_TO") >= CAST(P."INSR_BEGIN" AS DATE))),(  SELECT  COUNT(DISTINCT PAR."MAN_ID") 
																												                                       FROM    USINSIV01."POLICY_PARTICIPANTS" PAR
																												                                       WHERE   PAR."POLICY_ID" = P."POLICY_ID"
																												                                       AND     PAR."PARTICPANT_ROLE" = 'PHOLDER'
																												                                       AND     DATE_TRUNC('SECOND', PAR."VALID_FROM") <= CAST(P."INSR_BEGIN" AS DATE)
																												                                       AND     (PAR."VALID_TO" IS NULL OR DATE_TRUNC('SECOND', PAR."VALID_TO") >= CAST(P."INSR_BEGIN" AS DATE))))AS VARCHAR)
                        ) AS DQTDPART,
                        COALESCE(CAST(P."INSR_TYPE" AS VARCHAR), '') AS KACTPPRD,
                        ( SELECT PC."COND_VALUE" 
                          FROM USINSIV01."POLICY_CONDITIONS" PC
