        ...
        L_SBHISPR_INSIS =  '''
                                (
                                        ...
                                        select	'D' as INDDETREC,
                                                ...
                                                SUBSTRING(CAST(CAST(cl0."COVER_CPR_ID"as BIGINT) AS VARCHAR), 5, 10)  KGCTPCBT,
                                        ...
                                        from	(	select	cla.cla_id,
                                                ...
                                                from	(	select	cla."CLAIM_ID",
                                                                                ...
                                                                                coalesce(
                                                                                        (
                                                                                                ...
                                                                                                and     coalesce(acc."ACCINS_TYPE",'0') = case obj."INSR_TYPE" 
                                                                                                                                                                                        when 2007 then '0' 
                                                                                                                                                                                        when 2004 then '0' 
                                                                                                                                                                                        when 2001 then '0' 
                                                                                                                                                                                        else '1' 
                                                ...
                                                join usinsiv01."CPR_COVER" cpr_cover on clo."COVER_TYPE" = cpr_cover."COVER_TYPE" 
                                                join usinsiv01."CLAIM_RESERVE_HISTORY" clh 	on clh."CLAIM_ID" = clo."CLAIM_ID"	
                                                                                                ...
                                                                                                and		cast(clh."REGISTRATION_DATE" as date) <= '12-31-2023') cl0
