...
def get_data(glue_context, connection):
    ...
    L_RBCOMIS_INSUNIX_LPG_INCENDIO = '''
                                        (
    ...
    L_RBCOMIS_INSUNIX_LPG_OTROS_RAMOS = '''
                                           (
                                                select 	'D' as INDDETREC,
                                                        'RBCOMIS' as TABLAIFRS17,
                                                        pre.receipt KRBRECPR, --
    ...
    L_RBCOMIS_INSUNIX_LPV_OTROS_RAMOS = '''
                                           (
                                                select 	'D' INDDETREC,
                                                        'RBCOMIS' TABLAIFRS17,
                                                        pre.receipt KRBRECPR,
                                                ...
                                                from	(	select	dpr.pre_id,
                                                        ...
                                                        from	(
                                                                                select	pre.ctid pre_id,
                                                                                                                dpr.compdate ,
                                                                                                        coalesce(
                                                                                                                case 
                                                                                                                                when coalesce(
                                                                                                                                                                (select  distinct pro.brancht
                                                                                                                                        ...
                                                                                                                                        and		(pro.nulldate is null or pro.nulldate > pre.effecdate)
                                                                                                                                        ),'0'
                                                                                                                                ) not in ('1','5')
                                                                                                                                                then    (
                                                                                                                                                                        select  distinct gco.covergen
                                                                                                                                                                                                        ...
                                                                                                                                                                                                        coalesce( 
                                                                                                                                                                                                                coalesce(
                                                                                                                                                                                                                                coalesce(
                                                                                                                                                                                                                                                ...
                                                                                                                                                                                                                                                and 	 product = pre.product 
                                                                                                                                                                                                                                                and   currency = cov.currency --�ndice regular
                                                                                                                                                                                                                                                                                and	 modulec = cov.modulec 
                                                                                                                                                                                                                                                                                and   cover = cov.cover --variaci�n 1 con modulec
                                                                                                                                                                                                                                                                                and	 effecdate <= pre.effecdate 
                                                                                                                                                                                                                                                                                and   (nulldate is null or nulldate > pre.effecdate) --variaci�n 2 vigencias
                                                                                                                                                                                                                                                                                and	 statregt <> '4'
                                                                                                                                                                                                                                                                                ), --variaci�n 3 reg. v�lido
                                                                                                                                                                                                                                                                                        (select  max(ctid)
                                                                                                                                                                                                                                                                                        from	usinsuv01.gen_cover
                                                                                                                                                                                                                                                                                        where   usercomp = pre.usercomp 
                                                                                                                                                                                                                                                                                        and company = pre.company 
                                                                                                                                                                                                                                                                                        ...
                                                                                                                                                                                                                                                                                        and		statregt <> '4'
                                                                                                                                                                                                                                                                                                ...
                                                                                                                                                                                                                                                                                                ), -- no est� cortado, pero fue anulado antes del efecto del registro
                                                                                                                                                                                                                                                                                                                coalesce(
                                                                                                                                                                                                                                                                                                                        ( select  max(ctid)
                                                                                                                                                                                                                                                                                                                from	usinsuv01.gen_cover
                                                                                                                                                                                                                                                                                                                where usercomp = pre.usercomp 
                                                                                                                                                                                                                                                                                        ...
                                                                                                                                                                                                                                                                                        ), --no est� cortado y aparte fue anulado antes del efecto del registro
                                                                                                                                                                                                                                                                                                coalesce (
                                                                                                                                                                                                                                                                                                                coalesce( 
                                                                                                                                                                                                                                                                                                                        ( select  max(ctid)
                                                                                                                                                                                                                                                                                                                        from	usinsuv01.gen_cover
                                                                                                                                                                                                                                                                                                        ...
                                                                                                                                                                                                                                                                                                        ), -- no est� cortado, pero tampoco al efecto de la tabla de datos particular
                                                                                                                                                                                                                                                                                                                                coalesce(
                                                                                                                                                                                                                                                                                                                                        ( select  max(ctid)
                                                                                                                                                                                                                                                                                                                                from	usinsuv01.gen_cover
                                                                                                                                                                                                                                                                                                                                where   usercomp = pre.usercomp 
                                                                                                                                                                                                                                                                                ...
                                                                                                                                                                                                                                                                                ) --est� cortado y no al efecto de la tabla de datos particular adem�s de estar cortado
                                                                                                                                                                ...
                                                                                                                                                                coalesce(
                                                                                                                                                                                ...
                                                                                                                                                                                coalesce(
                                                                                                                                                                                        ...
                                                                                                                                                                                        (select  max(ctid)
                                                                                                                                                                                                ...
                                                                                                                                                                                                and branch = pre.branch 
                                                                                                                                                                                                and product = pre.product 
                                                                                                                                                                                                and currency = pre.currency --�ndice regular
                                                                                                                                                                                                ...
                                                                                                                                                                                                ), --est� cortado y aparte fue anulado antes del efecto del registro
                                                                                                                                                                                                                coalesce(
                                                                                                                                                                                                                        ( select  max(ctid)
                                                                                                                                                                                                                from 	usinsuv01.life_cover
                                                                                                                                                                                                                where   usercomp = pre.usercomp 
    ...
    L_RBCOMIS_INSUNIX_LPV_RENTA_VITALICIA  = '''
                                                (
                                                        select  'D' INDDETREC,
                                                                'RBCOMIS' TABLAIFRS17,
                                                                pre.receipt KRBRECPR,
                                                        ...
                                                        from	(	select 	dpr.pre_id,
                                                                ...
                                                                from	(	select	pre.ctid pre_id,
                                                                                        ...
                                                                                        sum(coalesce(dpr.commision,0)) commision
                                                                        from	usinsuv01.detail_pre dpr
                                                                        join	(select cast('12/31/2010' as date) fecha) par on 1 = 1 --fecha indicada
                                                                        join	usinsuv01.premium pre
                                                                                        on		pre.usercomp = dpr.usercomp
                                                                                        and 	pre.company = dpr.company
                                                                                        and		pre.receipt = dpr.receipt
    ...
    L_RBCOMIS_INSIS_LPV = '''
                          (
                              SELECT 
                                ...
                                WHERE BDO."DOC_CLASS" = 'B' AND "DOC_TYPE_ID" IN (19997, 19713)     
                          ) AS TMP      
                          '''
