def get_data(glue_context, connection):
  ...
  L_DF_PRODUCT = spark.read.parquet(l_dic_config['GENERAL']['Release_Business']['path4'])
  
  L_DF_PRODMASTER = spark.read.parquet(l_dic_config['GENERAL']['Release_Business']['path4'])
  
  L_DF_GEN_COVER = spark.read.parquet(l_dic_config['GENERAL']['Release_Business']['path4'])
  
  

  {"var": "l_product", "name" :"tmp/lectura/Productos/product_pvg.parquet"},
  {"var": "l_prodmaster", "name" : "tmp/lectura/Productos/table10_pvg.parquet"},
  {"var": "l_gen_cover", "name" : "tmp/lectura/Productos/gen_cover_pvg.parquet"}
