                       ...
                       from	(	select	cla.usercomp,
                                   ...
                                   from	(	select	cla.ctid cla_id,
                                               ...
                                               from 	(	select	prv.cla_id,
                                                                   prv.par_fin dat_lim
                                                           from 	(	--revisi�n ocurrencia (nuevos casos)
                                                                       ...
                                                                       join	usinsug01.claim cla
                                                                               ...
                                                                               and		cla.occurdat between dat.par_ini and dat.par_fin --ocurridos durante el rango
                                                                               and 	exists --que posean transacciones con montos (interacci�n con SBSIN)
                                                                                       (	select	1
                                                                       ...
                                                                       union
                                                                       --siniestros precargados anteriormente (sin importar la ocurrencia)
                                                                       select	cla.ctid cla_id,
                                                                               dat.par_ini,
                                                                               dat.par_fin,
                                                                               2 flag
                                                                       ...
                                                                       join	usinsug01.claim cla
                                                                               ...
                                                                               and		cla.branch in (select branch from usinsug01.table10b where company = 1)
                                                                               and		(cla.staclaim <> '6' or (cla.staclaim = '6' and cla.branch = 23))
                                                                               and		cla.occurdat < dat.par_ini --ocurrencia anterior al rango
                                                           ...
                                                           where	(	flag = 1 --siniestros nuevos en el rango
                                                                       and 	(	exists
                                                                                   (	select 	1
                                                                                   ...
                                                                                   (	select 	1
                                                                                       ...
                                                                                       join	usinsug01.policy pol
                                                                                               ...
                                                                                               and		pol.bussityp = '2'
                                                                                       where	cla.ctid = prv.cla_id)))
                                                           or		(	flag = 2 --siniestros con cambios en coinsuran (solo se consideran cambios a nivel de registros)
                                                                       and 	exists
                                                                               (	select 	1
                                                                                   from	usinsug01.claim cla
                                                                                   join	usinsug01.coinsuran coi
                                                                                           ...
                                                                                           and		coi.effecdate <= cla.occurdat
                                                                                           and		(coi.nulldate is null or coi.nulldate > cla.occurdat)
                                                                                           and		coi.compdate between prv.par_ini and prv.par_fin
    ...
    VTIME_LPG =  f'''
                     (select
                      ...
                      from	(	select  cla."NBRANCH" nbranch,
                                  ...
                                  join	(	select	cast('01/01/2023' as date) par_ini, --rango inicial carga incremental (variable a elecci�n)
                                                      cast('01/31/2023' as date) par_fin --rango final carga incremental (variable a elecci�n)
                                          ) dat on 1 = 1
                                  ...
                                  join	usvtimg01."CLAIM" cla
                                          ...
                                          and     cla."SSTACLAIM" <> '6'
                                          and		((	--siniestros ya existentes con cambios en la tabla coinsuran (no aplica a los coaseguros recibidos)
                                                      cla."DOCCURDAT" < dat.par_ini
                                                      ...
                                                      and (	pol."SBUSSITYP" = '1' and exists
                                                              (	select	1
                                                                  ...
                                                                  and     cast(coi."DEFFECDATE" as date) <= cast("DOCCURDAT" as date)
                                                                  and     (coi."DNULLDATE" is null or cast(coi."DNULLDATE" as date) > cast("DOCCURDAT" as date))
                                                                  and     cast(coi."DCOMPDATE" as date) between dat.par_ini and dat.par_fin)))
                                                  or	(	--siniestros nuevos en el rango de fechas con operaciones y esquemas de coaseguro/coaseguro recibido
                                                          cast(cla."DOCCURDAT" as date) between dat.par_ini and dat.par_fin
                                                          and		exists
                                                                  (   select  1
                                                                      from    usvtimg01."CLAIM_HIS" clh
                                                                      where	clh."NCLAIM" = cla."NCLAIM"
