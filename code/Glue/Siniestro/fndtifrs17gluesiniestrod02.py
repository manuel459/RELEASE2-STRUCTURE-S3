...
try:
    ...
    #-------------------------------------#
    job_name = f'fndtifrs17gluesiniestro{env}02_test'
    ...
    l_configuraciones = [{ "DOMINIO": "GENERAL" , "COLUMNA": "ESTRUCTURA" }, { "DOMINIO": "SINIESTROS" , "COLUMNA": "ESTRUCTURA" }]
    ...
    print(f"Error Glue de Estructura del Dominio de Siniestros: {str(e)}")
    nombre_error = str(e)
    trazabilidad.update_log(cliente_dynamodb, id, 2,2,nombre_error, last_start_time,tipo_carga)
    sys.exit(1)
