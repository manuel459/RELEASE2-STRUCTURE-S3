                        ...
                        SELECT
                         ...
                         AND (  -- INCREMENTAL
                              (P."SPOLITYPE" = '1' -- INDIVIDUAL 
                                AND P."DCOMPDATE" BETWEEN '{p_fecha_inicio}' AND '{p_fecha_fin}'  )
                              OR  
                              (P."SPOLITYPE" <> '1' -- COLECTIVAS 
                                AND CERT."DCOMPDATE" BETWEEN '{p_fecha_inicio}' AND '{p_fecha_fin}' )
                             )                                           
                      ) AS TMP'''
                              ...
                              (
                                ...
                                AND (  -- INCREMENTAL
                                    (P.POLITYPE = '1' -- INDIVIDUAL 
                                      AND P.COMPDATE BETWEEN '{p_fecha_inicio}' AND '{p_fecha_fin}'  )
                                    OR  
                                    (P.POLITYPE <> '1' -- COLECTIVAS 
                                      AND CERT.COMPDATE BETWEEN '{p_fecha_inicio}' AND '{p_fecha_fin}' )
                                    )  
                                )P
                          ) AS TMP 
                          '''
